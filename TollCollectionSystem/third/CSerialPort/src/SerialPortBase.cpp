...
void CSerialPortBase::setOperateMode(itas109::OperateMode operateMode) { m_operateMode = operateMode; }

unsigned int CSerialPortBase::getReadIntervalTimeout() { return m_readIntervalTimeoutMS; }

unsigned int CSerialPortBase::getMinByteReadNotify() { return m_minByteReadNotify; }
...
unsigned int CSerialPortBase::getByteReadBufferFullNotify() { return m_byteReadBufferFullNotify; }

int CSerialPortBase::getLastError() const { return m_lastError; }
...
void CSerialPortBase::clearError() { m_lastError = itas109::ErrorOK; }
