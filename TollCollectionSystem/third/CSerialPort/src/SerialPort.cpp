...
CSerialPort::CSerialPort() : p_serialPortBase(NULL) {
...
itas109::CSerialPort::CSerialPort(const char *portName) : p_serialPortBase(NULL) {
...
void itas109::CSerialPort::init(const char *portName, int baudRate /*= itas109::BaudRate::BaudRate9600*/,
